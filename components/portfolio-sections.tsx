    ...
    return (
        <section id={id} className={`py-20 w-full ${className}`}>
            <div className="container mx-auto px-4">
                <h2 className={`${titleStyle({ size: "lg" })} mb-12 text-center`}>{titleText}</h2>
                {children}
            </div>
        </section>
    );
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                <div className="glass-card backdrop-blur-sm p-8 rounded-xl border border-white/20 shadow-xl">
                    ...
                    <p className="text-lg mt-4 text-gray-300">
                        Saya adalah seorang pengembang web dengan pengalaman dalam membangun aplikasi modern
                        dan responsif. Saya berkomitmen untuk membuat produk yang indah, fungsional,
                        dan ramah pengguna.
                    </p>
                    <p className="mt-4 text-gray-300">
                        Dengan latar belakang dalam desain dan pengembangan frontend,
                        saya menggabungkan kreativitas dan keterampilan teknis untuk menciptakan
        ...
        <PortfolioSection id="skills" titleText="Keterampilan">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {skills.map((skill, index) => (
                    <div key={index} className="glass-card backdrop-blur-sm p-6 rounded-xl border border-white/20 shadow-xl">
    ...
    const projects = [
        {
            ...
            description: "Platform e-commerce modern yang dibangun dengan Next.js dan Tailwind CSS.",
        ...
        },
        {
            ...
            description: "Website portofolio responsif dengan animasi dan efek modern.",
            image: "https://images.unsplash.com/photo-1539158026586-35e9e5c55f42?q=80&w=1972&auto=format&fit=crop",
            tags: ["React", "Framer Motion", "Styled Components"],
            link: "#",
        },
        {
            title: "Task Management App",
            description: "Aplikasi manajemen tugas dengan fitur drag-and-drop dan notifikasi.",
        ...
        <PortfolioSection id="projects" titleText="Proyek">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {projects.map((project, index) => (
                    <div key={index} className="glass-card backdrop-blur-sm border border-white/20 shadow-xl overflow-hidden rounded-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="glass-card backdrop-blur-sm p-8 rounded-xl border border-white/20 shadow-xl">
                    ...
                    <p className="text-gray-300 mt-2 mb-6">
                        Tertarik untuk bekerja sama? Jangan ragu untuk menghubungi saya melalui form ini.
                    </p>
                    ...
                    <div className="space-y-6">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <a href="mailto:email@example.com" className="text-primary">
                                    email@example.com
                                </a>
                            </div>
                        </div>
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <a href="tel:+628123456789" className="text-primary">
                                    +62 812 3456 789
                                </a>
                            </div>
                        </div>
